...
IMAGEX_RPC_PORT = os.getenv('IMAGEX_RPC_PORT', 20000)
UI_RPC_PORT = os.getenv('UI_RPC_PORT', 20001)
LIGHTX_RPC_PORT = os.getenv('LIGHTX_RPC_PORT', 20002)
DEEPX_RPC_PORT = os.getenv('DEEPX_RPC_PORT', 20003)
